...
let package = Package(
    ...
    products: [ .library(name: "SwiftGodot2D", type: .dynamic, targets: ["SwiftGodot2D"]) ],
    traits: [
        .trait(
    ...
    targets: [
        .target(name: "SwiftGodot2D",
            ...
            linkerSettings: [ .unsafeFlags(["-Xlinker", "-reexport-lSwiftGodotCore", "-Xlinker", "-reexport-lSwiftGodotServers"]) ],
