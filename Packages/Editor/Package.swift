...
let package = Package(
    ...
    targets: [
        .target(name: "SwiftGodotEditor",
            ...
            linkerSettings: [ .unsafeFlags(["-Xlinker","-reexport-lSwiftGodotCore","-Xlinker","-reexport-lSwiftGodotServers","-Xlinker","-reexport-lSwiftGodotControls","-Xlinker","-reexport-lSwiftGodot3D","-Xlinker","-reexport-lSwiftGodotGLTF","-Xlinker","-reexport-lSwiftGodotXR"]) ],
