...
/// Split module dependency graph: module name -> its direct dependency modules.
var moduleDeps: [String: Set<String>] = [:]
/// Split partition: class name -> the module that owns (generates) it.
var classHome: [String: String] = [:]
var moduleGraphProvided = false
