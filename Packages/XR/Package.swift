...
let package = Package(
    ...
    targets: [
        .target(name: "SwiftGodotXR",
            ...
            linkerSettings: [ .unsafeFlags(["-Xlinker","-reexport-lSwiftGodotCore","-Xlinker","-reexport-lSwiftGodotServers","-Xlinker","-reexport-lSwiftGodotControls","-Xlinker","-reexport-lSwiftGodot3D"]) ],
