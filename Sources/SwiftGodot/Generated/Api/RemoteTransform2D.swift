...
open class RemoteTransform2D: Node2D {
        ...
        withUnsafePointer(to: path.content) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(RemoteTransform2D.method_set_remote_node, UnsafeMutableRawPointer(mutating: handle), pArgs, nil)
                }
    ...
    fileprivate final func set_use_global_coordinates(_ useGlobalCoordinates: Bool) {
        withUnsafePointer(to: useGlobalCoordinates) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(RemoteTransform2D.method_set_use_global_coordinates, UnsafeMutableRawPointer(mutating: handle), pArgs, nil)
                }
    ...
    fileprivate final func set_update_position(_ updateRemotePosition: Bool) {
        withUnsafePointer(to: updateRemotePosition) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(RemoteTransform2D.method_set_update_position, UnsafeMutableRawPointer(mutating: handle), pArgs, nil)
                }
    ...
    fileprivate final func set_update_rotation(_ updateRemoteRotation: Bool) {
        withUnsafePointer(to: updateRemoteRotation) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(RemoteTransform2D.method_set_update_rotation, UnsafeMutableRawPointer(mutating: handle), pArgs, nil)
                }
    ...
    fileprivate final func set_update_scale(_ updateRemoteScale: Bool) {
        withUnsafePointer(to: updateRemoteScale) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(RemoteTransform2D.method_set_update_scale, UnsafeMutableRawPointer(mutating: handle), pArgs, nil)
                }
