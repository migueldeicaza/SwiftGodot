...
/// 
/// **Differences between packed arrays, typed arrays, and untyped arrays:** Packed arrays are generally faster to iterate on and modify compared to a typed array of the same type (e.g. ``PackedFloat64Array`` versus `Arrayfloat`). Also, packed arrays consume less memory. As a downside, packed arrays are less flexible as they don't offer as many convenience methods such as ``GArray/map()``. Typed arrays are in turn faster to iterate on and modify than untyped arrays.
/// 
...
/// 
public class PackedFloat64Array: Equatable, Collection, RandomAccessCollection {
    ...
    public required init(content proxyContent: ContentType) {
        withUnsafePointer(to: proxyContent) { pContent in
            withUnsafePointer(to: pContent) { pArgs in
                PackedFloat64Array.constructor1(&content, pArgs)
            }
        }
    }
    ...
    public init (from: GArray) {
        withUnsafePointer(to: from.content) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    PackedFloat64Array.constructor2(&content, pArgs)
                }
            ...
            withUnsafePointer(to: value) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        PackedFloat64Array.method_set(&content, pArgs, nil, 2)
                    }
    ...
    public final func pushBack(value: Double)-> Bool {
        ...
        withUnsafePointer(to: value) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    PackedFloat64Array.method_push_back(&content, pArgs, &result, 1)
                }
    ...
    public final func append(_ value: Double)-> Bool {
        var result: Bool = Bool()
        let value = Double(value)
        withUnsafePointer(to: value) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    PackedFloat64Array.method_append(&content, pArgs, &result, 1)
                }
    ...
    public final func appendArray(_ array: PackedFloat64Array) {
        withUnsafePointer(to: array.content) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    PackedFloat64Array.method_append_array(&content, pArgs, nil, 1)
                }
    ...
    public final func removeAt(index: Int64) {
        withUnsafePointer(to: index) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    PackedFloat64Array.method_remove_at(&content, pArgs, nil, 1)
                }
    ...
    public final func insert(atIndex: Int64, value: Double)-> Int64 {
        ...
        withUnsafePointer(to: atIndex) { pArg0 in
            ...
            withUnsafePointer(to: value) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        PackedFloat64Array.method_insert(&content, pArgs, &result, 2)
                    }
    ...
    public final func fill(value: Double) {
        ...
        withUnsafePointer(to: value) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    PackedFloat64Array.method_fill(&content, pArgs, nil, 1)
                }
    ...
    public final func resize(newSize: Int64)-> Int64 {
        ...
        withUnsafePointer(to: newSize) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    PackedFloat64Array.method_resize(&content, pArgs, &result, 1)
                }
    ...
    public final func has(value: Double)-> Bool {
        ...
        withUnsafePointer(to: value) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    PackedFloat64Array.method_has(&content, pArgs, &result, 1)
                }
    ...
    public final func slice(begin: Int64, end: Int64 = 2147483647)-> PackedFloat64Array {
        ...
        withUnsafePointer(to: begin) { pArg0 in
            withUnsafePointer(to: end) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        PackedFloat64Array.method_slice(&content, pArgs, &result.content, 2)
                    }
    ...
    public final func bsearch(value: Double, before: Bool = true)-> Int64 {
        ...
        withUnsafePointer(to: value) { pArg0 in
            withUnsafePointer(to: before) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        PackedFloat64Array.method_bsearch(&content, pArgs, &result, 2)
                    }
    ...
    public final func find(value: Double, from: Int64 = 0)-> Int64 {
        ...
        withUnsafePointer(to: value) { pArg0 in
            withUnsafePointer(to: from) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        PackedFloat64Array.method_find(&content, pArgs, &result, 2)
                    }
    ...
    public final func rfind(value: Double, from: Int64 = -1)-> Int64 {
        ...
        withUnsafePointer(to: value) { pArg0 in
            withUnsafePointer(to: from) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        PackedFloat64Array.method_rfind(&content, pArgs, &result, 2)
                    }
    ...
    public final func count(value: Double)-> Int64 {
        ...
        withUnsafePointer(to: value) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    PackedFloat64Array.method_count(&content, pArgs, &result, 1)
                }
    ...
    public static func == (lhs: PackedFloat64Array, rhs: PackedFloat64Array) -> Bool  {
        ...
        withUnsafePointer(to: lhs.content) { pArg0 in
            withUnsafePointer(to: rhs.content) { pArg1 in
                PackedFloat64Array.operator_5(pArg0, pArg1, &result)
            }
    ...
    public static func != (lhs: PackedFloat64Array, rhs: PackedFloat64Array) -> Bool  {
        ...
        withUnsafePointer(to: lhs.content) { pArg0 in
            withUnsafePointer(to: rhs.content) { pArg1 in
                PackedFloat64Array.operator_6(pArg0, pArg1, &result)
            }
    ...
    public static func + (lhs: PackedFloat64Array, rhs: PackedFloat64Array) -> PackedFloat64Array  {
        ...
        withUnsafePointer(to: lhs.content) { pArg0 in
            withUnsafePointer(to: rhs.content) { pArg1 in
                PackedFloat64Array.operator_7(pArg0, pArg1, &result.content)
            }
