...
@_spi(SwiftGodotRuntimePrivate) public struct GodotInterface {
    ...
    @inline(__always)
    public func object_method_bind_ptrcall_v(
    ...
    @inline(__always)
    public func object_method_bind_call_v(
        _ method: GDExtensionMethodBindPtr?,
        _ object: GDExtensionObjectPtr?,
    ...
    public let variant_evaluate: GDExtensionInterfaceVariantEvaluate
    public let variant_hash: GDExtensionInterfaceVariantHash
