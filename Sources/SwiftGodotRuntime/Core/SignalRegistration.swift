...
public struct SignalWithNoArguments {
    ...
    public init(_ signalName: String) {
        name = StringName(_convertMemberNameToMatchGodotConvention(signalName))
    }
}
...
public struct SignalWith1Argument<Argument: _GodotBridgeable> {
    ...
    public init(
        ...
        name = StringName(_convertMemberNameToMatchGodotConvention(signalName))
        arguments = [
            PropInfo(propertyType: Argument.self, propertyName: .init(_convertMemberNameToMatchGodotConvention(argument1Name ?? "arg1")))
        ]
    }
}
...
> {
    ...
    public init(
        ...
        name = StringName(_convertMemberNameToMatchGodotConvention(signalName))
        arguments = [
            PropInfo(propertyType: Argument1.self, propertyName: .init(_convertMemberNameToMatchGodotConvention(argument1Name ?? "arg1"))),
            PropInfo(propertyType: Argument2.self, propertyName: .init(_convertMemberNameToMatchGodotConvention(argument2Name ?? "arg2"))),
        ]
    }
}
...
> {
    ...
    public init(
        ...
        arguments = [
            PropInfo(propertyType: Argument1.self, propertyName: .init(_convertMemberNameToMatchGodotConvention(argument1Name ?? "arg1"))),
            PropInfo(propertyType: Argument2.self, propertyName: .init(_convertMemberNameToMatchGodotConvention(argument2Name ?? "arg2"))),
            PropInfo(propertyType: Argument3.self, propertyName: .init(_convertMemberNameToMatchGodotConvention(argument3Name ?? "arg3"))),
        ]
    }
}
...
> {
    ...
    public init(
        ...
        arguments = [
            ...
            PropInfo(propertyType: Argument2.self, propertyName: .init(_convertMemberNameToMatchGodotConvention(argument2Name ?? "arg2"))),
            PropInfo(propertyType: Argument3.self, propertyName: .init(_convertMemberNameToMatchGodotConvention(argument3Name ?? "arg3"))),
            PropInfo(propertyType: Argument4.self, propertyName: .init(_convertMemberNameToMatchGodotConvention(argument4Name ?? "arg4")))
        ]
    }
}
...
> {
    ...
    public init(
        ...
        arguments = [
            ...
            PropInfo(propertyType: Argument3.self, propertyName: .init(_convertMemberNameToMatchGodotConvention(argument3Name ?? "arg3"))),
            PropInfo(propertyType: Argument4.self, propertyName: .init(_convertMemberNameToMatchGodotConvention(argument4Name ?? "arg4"))),
            PropInfo(propertyType: Argument5.self, propertyName: .init(_convertMemberNameToMatchGodotConvention(argument5Name ?? "arg5")))
        ]
    }
}
...
> {
    ...
    public init(
        ...
        arguments = [
            ...
            PropInfo(propertyType: Argument4.self, propertyName: .init(_convertMemberNameToMatchGodotConvention(argument4Name ?? "arg4"))),
            PropInfo(propertyType: Argument5.self, propertyName: .init(_convertMemberNameToMatchGodotConvention(argument5Name ?? "arg5"))),
            PropInfo(propertyType: Argument6.self, propertyName: .init(_convertMemberNameToMatchGodotConvention(argument6Name ?? "arg6")))
        ]
    }
}
