...
public final class EngineVector3Tests: GodotTestCase {
    ...
    public override class var allTests: [GodotTest] {
        [
            ...
            GodotTest(name: "testPlaneMethods", method: testPlaneMethods),
