...
final class Geometry2DTests {
    ...
    public func testPointInCircle () {
        assertTrue (Geometry2D.isPointInCircle (point: Vector2 (x: 0, y: 0), circlePosition: Vector2 (x: 0, y: 0), circleRadius: 1.0))
        
        assertTrue (Geometry2D.isPointInCircle (point: Vector2 (x: 0, y: 0), circlePosition: Vector2 (x: 11.99, y: 0), circleRadius: 12))
        assertTrue (Geometry2D.isPointInCircle (point: Vector2 (x: -11.99, y: 0), circlePosition: Vector2 (x: 0, y: 0), circleRadius: 12))
        
        assertFalse (Geometry2D.isPointInCircle (point: Vector2 (x: 0, y: 0), circlePosition: Vector2 (x: 12.01, y: 0), circleRadius: 12))
        assertFalse (Geometry2D.isPointInCircle (point: Vector2 (x: -12.01, y: 0), circlePosition: Vector2 (x: 0, y: 0), circleRadius: 12))
        
        assertTrue (Geometry2D.isPointInCircle (point: Vector2 (x: 7, y: -42), circlePosition: Vector2 (x: 4, y: -40), circleRadius: 3.7))
        assertFalse (Geometry2D.isPointInCircle (point: Vector2 (x: 7, y: -42), circlePosition: Vector2 (x: 4, y: -40), circleRadius: 3.5))
        
        // This tests points on the edge of the circle. They are treated as being inside the circle.
        assertTrue (Geometry2D.isPointInCircle (point: Vector2 (x: 1.0, y: 0.0), circlePosition: Vector2 (x: 0, y: 0), circleRadius: 1.0))
        assertTrue (Geometry2D.isPointInCircle (point: Vector2 (x: 0.0, y: -1.0), circlePosition: Vector2 (x: 0, y: 0), circleRadius: 1.0))
    }

    public func testPointInTriangle () {
        assertTrue (Geometry2D.pointIsInsideTriangle (point: Vector2 (x: 0, y: 0), a: Vector2 (x: -1, y: 1), b: Vector2 (x: 0, y: -1), c: Vector2 (x: 1, y: 1)))
        assertFalse (Geometry2D.pointIsInsideTriangle (point: Vector2 (x: -1.01, y: 1.0), a: Vector2 (x: -1, y: 1), b: Vector2 (x: 0, y: -1), c: Vector2 (x: 1, y: 1)))
        
        assertTrue (Geometry2D.pointIsInsideTriangle (point: Vector2 (x: 3, y: 2.5), a: Vector2 (x: 1, y: 4), b: Vector2 (x: 3, y: 2), c: Vector2 (x: 5, y: 4)))
        assertTrue (Geometry2D.pointIsInsideTriangle (point: Vector2 (x: -3, y: -2.5), a: Vector2 (x: -1, y: -4), b: Vector2 (x: -3, y: -2), c: Vector2 (x: -5, y: -4)))
        assertFalse (Geometry2D.pointIsInsideTriangle (point: Vector2 (x: 0, y: 0), a: Vector2 (x: 1, y: 4), b: Vector2 (x: 3, y: 2), c: Vector2 (x: 5, y: 4)))
        ...
        assertFalse (Geometry2D.pointIsInsideTriangle (point: Vector2 (x: 1, y: 1), a: Vector2 (x: -1, y: 1), b: Vector2 (x: 0, y: -1), c: Vector2 (x: 1, y: 1)))
        assertFalse (Geometry2D.pointIsInsideTriangle (point: Vector2 (x: 0, y: 1), a: Vector2 (x: -1, y: 1), b: Vector2 (x: 0, y: -1), c: Vector2 (x: 1, y: 1)))
    }
    
    public func testPointInPolygon () {
        let p = PackedVector2Array ()
        assertFalse (Geometry2D.isPointInPolygon (point: Vector2 (x: 0, y: 0), polygon: p))
        ...
        assertFalse (Geometry2D.isPointInPolygon (point: Vector2 (x: -350, y: 0), polygon: p))
        assertFalse (Geometry2D.isPointInPolygon (point: Vector2 (x: -110, y: 60), polygon: p))
        assertFalse (Geometry2D.isPointInPolygon (point: Vector2 (x: 412, y: 96), polygon: p))
        assertFalse (Geometry2D.isPointInPolygon (point: Vector2 (x: 83, y: 130), polygon: p))
        assertFalse (Geometry2D.isPointInPolygon (point: Vector2 (x: -320, y: -153), polygon: p))
        
        assertTrue (Geometry2D.isPointInPolygon (point: Vector2 (x: 0, y: 0), polygon: p))
        assertTrue (Geometry2D.isPointInPolygon (point: Vector2 (x: -230, y: 0), polygon: p))
        assertTrue (Geometry2D.isPointInPolygon (point: Vector2 (x: 130, y: -110), polygon: p))
        assertTrue (Geometry2D.isPointInPolygon (point: Vector2 (x: 370, y: 55), polygon: p))
        assertTrue (Geometry2D.isPointInPolygon (point: Vector2 (x: -160, y: 190), polygon: p))
        
        // This tests points on the edge of the polygon. They are treated as being inside the polygon.
        let c = Int (p.size ())
        for i in 0..<c {
            let p1 = p [i]
            assertTrue (Geometry2D.isPointInPolygon (point: p1, polygon: p))
            
            let p2 = p [(i + 1) % c]
            let midpoint = ((p1 + p2) * 0.5)
            assertTrue (Geometry2D.isPointInPolygon (point: midpoint, polygon: p))
        }
    }
    
    public func testPolygonClockwise () {
        let p = PackedVector2Array ()
        assertFalse (Geometry2D.isPolygonClockwise (polygon: p))
        ...
        p.pushBack (value: Vector2 (x: 1, y: 5))
        assertTrue (Geometry2D.isPolygonClockwise (polygon: p))
    ...
    public func testSegmentIntersection () {
        ...
        assertEqual (r?.gtype, .vector2)
        assertEqual (r.map { Vector2($0) }, Vector2 (x: 0, y: 0))
        ...
        assertEqual (r, nil, "Parallel segments should not intersect.")
        ...
        assertEqual (r, nil,"Non-overlapping collinear segments should not intersect.")
        ...
        assertEqual (r?.gtype, .vector2, "Touching segments should intersect.")
        assertEqual (r.map { Vector2($0) }, Vector2 (x: 0, y: 0))
    ...
    public func testSegmentIntersectionWithCircle () {
        ...
        assertEqual (Geometry2D.segmentIntersectsCircle (segmentFrom: Vector2 (x: 0, y: 0), segmentTo: Vector2 (x: 4, y: 0), circlePosition: Vector2 (x: 0, y: 0), circleRadius: 1.0), oneQuarter, "Segment from inside to outside of circle should intersect it.")
        assertEqual (Geometry2D.segmentIntersectsCircle (segmentFrom: Vector2 (x: 4, y: 0), segmentTo: Vector2 (x: 0, y: 0), circlePosition: Vector2 (x: 0, y: 0), circleRadius: 1.0), threeQuarters, "Segment from outside to inside of circle should intersect it.")
        
        assertEqual (Geometry2D.segmentIntersectsCircle (segmentFrom: Vector2 (x: -2, y: 0), segmentTo: Vector2 (x: 2, y: 0), circlePosition: Vector2 (x: 0, y: 0), circleRadius: 1.0), oneQuarter, "Segment running through circle should intersect it.")
        assertEqual (Geometry2D.segmentIntersectsCircle (segmentFrom: Vector2 (x: 2, y: 0), segmentTo: Vector2 (x: -2, y: 0), circlePosition: Vector2 (x: 0, y: 0), circleRadius: 1.0), oneQuarter, "Segment running through circle should intersect it.")
        
        assertEqual (Geometry2D.segmentIntersectsCircle (segmentFrom: Vector2 (x: 0, y: 0), segmentTo: Vector2 (x: 1, y: 0), circlePosition: Vector2 (x: 0, y: 0), circleRadius: 1.0), one, "Segment starting inside the circle and ending on the circle should intersect it")
        assertEqual (Geometry2D.segmentIntersectsCircle (segmentFrom: Vector2 (x: 1, y: 0), segmentTo: Vector2 (x: 0, y: 0), circlePosition: Vector2 (x: 0, y: 0), circleRadius: 1.0), zero, "Segment starting on the circle and going inwards should intersect it")
        assertEqual (Geometry2D.segmentIntersectsCircle (segmentFrom: Vector2 (x: 1, y: 0), segmentTo: Vector2 (x: 2, y: 0), circlePosition: Vector2 (x: 0, y: 0), circleRadius: 1.0), zero, "Segment starting on the circle and going outwards should intersect it")
        assertEqual (Geometry2D.segmentIntersectsCircle (segmentFrom: Vector2 (x: 2, y: 0), segmentTo: Vector2 (x: 1, y: 0), circlePosition: Vector2 (x: 0, y: 0), circleRadius: 1.0), one, "Segment starting outside the circle and ending on the circle intersect it")
        
        assertEqual (Geometry2D.segmentIntersectsCircle (segmentFrom: Vector2 (x: -1, y: 0), segmentTo: Vector2 (x: 1, y: 0), circlePosition: Vector2 (x: 0, y: 0), circleRadius: 2.0), minusOne, "Segment completely within the circle should not intersect it")
        assertEqual (Geometry2D.segmentIntersectsCircle (segmentFrom: Vector2 (x: 1, y: 0), segmentTo: Vector2 (x: -1, y: 0), circlePosition: Vector2 (x: 0, y: 0), circleRadius: 2.0), minusOne, "Segment completely within the circle should not intersect it")
        assertEqual (Geometry2D.segmentIntersectsCircle (segmentFrom: Vector2 (x: 2, y: 0), segmentTo: Vector2 (x: 3, y: 0), circlePosition: Vector2 (x: 0, y: 0), circleRadius: 1.0), minusOne, "Segment completely outside the circle should not intersect it")
        assertEqual (Geometry2D.segmentIntersectsCircle (segmentFrom: Vector2 (x: 3, y: 0), segmentTo: Vector2 (x: 2, y: 0), circlePosition: Vector2 (x: 0, y: 0), circleRadius: 1.0), minusOne, "Segment completely outside the circle should not intersect it")
    }

    public func testClosestPointToSegment () {
        assertEqual (Geometry2D.getClosestPointToSegment (point: Vector2 (x: 4.1, y: 4.1), s1: Vector2 (x: -4, y: -4), s2: Vector2 (x: 4, y: 4)), Vector2 (x: 4, y: 4))
        assertEqual (Geometry2D.getClosestPointToSegment (point: Vector2 (x: -4.1, y: -4.1), s1: Vector2 (x: -4, y: -4), s2: Vector2 (x: 4, y: 4)), Vector2 (x: -4, y: -4))
        assertEqual (Geometry2D.getClosestPointToSegment (point: Vector2 (x: -1, y: 1), s1: Vector2 (x: -4, y: -4), s2: Vector2 (x: 4, y: 4)), Vector2 (x: 0, y: 0))
        
        assertEqual (Geometry2D.getClosestPointToSegment (point: Vector2 (x: -3, y: 4), s1: Vector2 (x: 1, y: -2), s2: Vector2 (x: 1, y: -2)), Vector2 (x: 1, y: -2), "Line segment is only a single point. This point should be the closest.")
    }
    ...
    public func testClosestPointsBetweenSegments () {
        ...
        assertEqual (r [safe: 0], Vector2 (x: 3, y: 3))
        assertEqual (r [safe: 1], Vector2 (x: 4, y: 4))
        
        r = Geometry2D.getClosestPointsBetweenSegments (p1: Vector2 (x: 0, y: 1), q1: Vector2 (x: -2, y: -1), p2: Vector2 (x: 0, y: 0), q2: Vector2 (x: 2, y: -2))
        assertEqual (r.count, 2)
        assertEqual (r [safe: 0], Vector2 (x: -0.5, y: 0.5))
        assertEqual (r [safe: 1], Vector2 (x: 0, y: 0))
        
        r = Geometry2D.getClosestPointsBetweenSegments (p1: Vector2 (x: -1, y: 1), q1: Vector2 (x: 1, y: -1), p2: Vector2 (x: 1, y: 1), q2: Vector2 (x: -1, y: -1))
        assertEqual (r.count, 2)
        assertEqual (r [safe: 0], Vector2 (x: 0, y: 0))
        assertEqual (r [safe: 1], Vector2 (x: 0, y: 0))
        
        r = Geometry2D.getClosestPointsBetweenSegments (p1: Vector2 (x: -3, y: 4), q1: Vector2 (x: -3, y: 4), p2: Vector2 (x: -4, y: 3), q2: Vector2 (x: -2, y: 3))
        assertEqual (r.count, 2)
        assertEqual (r [safe: 0], Vector2 (x: -3, y: 4), "1st line segment is only a point, this point should be the closest point to the 2nd line segment.")
        assertEqual (r [safe: 1], Vector2 (x: -3, y: 3), "1st line segment is only a point, this should not matter when determining the closest point on the 2nd line segment.")
        
        r = Geometry2D.getClosestPointsBetweenSegments (p1: Vector2 (x: -4, y: 3), q1: Vector2 (x: -2, y: 3), p2: Vector2 (x: -3, y: 4), q2: Vector2 (x: -3, y: 4))
        assertEqual (r.count, 2)
        assertEqual (r [safe: 0], Vector2 (x: -3, y: 3), "2nd line segment is only a point, this should not matter when determining the closest point on the 1st line segment.")
        assertEqual (r [safe: 1], Vector2 (x: -3, y: 4), "2nd line segment is only a point, this point should be the closest point to the 1st line segment.")
        
        r = Geometry2D.getClosestPointsBetweenSegments (p1: Vector2 (x: 5, y: -4), q1: Vector2 (x: 5, y: -4), p2: Vector2 (x: -2, y: 1), q2: Vector2 (x: -2, y: 1))
        assertEqual (r.count, 2)
        assertEqual (r [safe: 0], Vector2 (x: 5, y: -4), "Both line segments are only a point. On the 1st line segment, that point should be the closest point to the 2nd line segment.")
        assertEqual (r [safe: 1], Vector2 (x: -2, y: 1), "Both line segments are only a point. On the 2nd line segment, that point should be the closest point to the 1st line segment.")
    }
    ...
    public func testMakeAtlas () {
        ...
        assertEqual (result ["size"], Variant (Vector2i (x: 2, y: 2)))
        assertEqual (result ["points"]?.description, "[(0.0, 0.0)]")
        ...
        result = Geometry2D.makeAtlas (sizes: r)
        assertEqual (result.size (), 2)
        assertEqual (result["points"].map { PackedVector2Array($0)?.size() }, r.size())
    }
    ...
    public func testPolygonIntersection () {
        ...
        assertTrue (r.isEmpty (), "Both polygons are empty. The intersection should also be empty.")
        
        r = Geometry2D.intersectPolygons (polygonA: a, polygonB: b)
        assertTrue (r.isEmpty (), "One polygon is empty. The intersection should also be empty.")
        ...
        r = Geometry2D.intersectPolygons (polygonA: a, polygonB: b)
        assertEqual (r.size (), 1, "The polygons should intersect each other with 1 resulting intersection polygon.")
        assertEqual (r [safe: 0]?.size (), 3, "The resulting intersection polygon should have 3 vertices.")
        ...
        r = Geometry2D.intersectPolygons (polygonA: a, polygonB: b)
        assertTrue (r.isEmpty (), "The polygons should not intersect each other.")
        ...
        r = Geometry2D.intersectPolygons (polygonA: a, polygonB: b)
        assertEqual (r.size (), 2, "The polygons should intersect each other with 2 resulting intersection polygons.")
        assertEqual (r [safe: 0]?.size (), 4, "The resulting intersection polygon should have 4 vertices.")
        ...
        assertEqual (r [safe: 1]?.size (), 3, "The intersection polygon should have 3 vertices.")
    ...
    public func testMergePolygons () {
        ...
        assertTrue (r.isEmpty (), "Both polygons are empty. The union should also be empty.")
        
        // One polygon is empty
        r = Geometry2D.mergePolygons (polygonA: a, polygonB: b)
        assertEqual (r.size (), 1, "One polygon is non-empty. There should be 1 resulting merged polygon.")
        assertEqual (r [safe: 0]?.size (), 4, "The resulting merged polygon should have 4 vertices.")
        ...
        r = Geometry2D.mergePolygons (polygonA: a, polygonB: b)
        assertEqual (r.size (), 1, "The merged polygons should result in 1 polygon.")
        assertEqual (r [safe: 0]?.size (), 7, "The resulting merged polygon should have 7 vertices.")
        ...
        b.pushBack (value: Vector2 (x: 160, y: 80))
        r = Geometry2D.mergePolygons (polygonA: a, polygonB: b)
        assertEqual (r.size (), 2, "The merged polygons should result in 2 polygons.")
                
        if let polygon = r[safe: 0] {
            assertTrue (!Geometry2D.isPolygonClockwise (polygon: polygon), "The merged polygon (outline) should be counter-clockwise.")
        } else {
            fail()
        }
                
        assertEqual (r [safe: 0]?.size (), 7, "The resulting merged polygon (outline) should have 7 vertices.")
        assertApproxEqual (r [safe: 0]?[safe: 0], Vector2 (x: 174.791077, y: 161.350967))
        assertApproxEqual (r [safe: 0]?[safe: 1], Vector2 (x: 225, y: 180))
        assertApproxEqual (r [safe: 0]?[safe: 2], Vector2 (x: 160, y: 230))
        assertApproxEqual (r [safe: 0]?[safe: 3], Vector2 (x: 20, y: 212))
        ...
        if let polygon = r[safe: 1] {
            assertTrue (Geometry2D.isPolygonClockwise (polygon: polygon), "The resulting merged polygon (hole) should be clockwise.")
        } else {
            fail()
        }
        
        assertEqual (r [safe: 1]?.size (), 3, "The resulting merged polygon (hole) should have 3 vertices.")
    ...
    public func testClipPolygons () {
        ...
        assertTrue (r.isEmpty (), "Both polygons are empty. The clip should also be empty.")
        ...
        assertEqual (r.size (), 1, "The clipped polygons should result in 1 polygon.")
        assertEqual (r [safe: 0]?.size (), 3, "The resulting clipped polygon should have 3 vertices.")
        ...
        r = Geometry2D.clipPolygons (polygonA: a, polygonB: b)
        assertTrue (r.isEmpty (), "Polygon 'b' completely overlaps polygon 'a'. This should result in no clipped polygons.")
        ...
        r = Geometry2D.clipPolygons (polygonA: a, polygonB: b)
        assertEqual (r.size (), 2, "Polygon 'a' completely overlaps polygon 'b'. This should result in 2 clipped polygons.")
        assertEqual (r [safe: 0]?.size (), 4, "The resulting clipped polygon should have 4 vertices.")
        
        if let polygon = r[safe: 0] {
            assertTrue (!Geometry2D.isPolygonClockwise (polygon: polygon), "The resulting clipped polygon (outline) should be counter-clockwise.")
        } else {
            fail()
        }
        ...
        assertApproxEqual (r [safe: 0]?[safe: 2], a [2])
        assertApproxEqual (r [safe: 0]?[safe: 3], a [3])
        assertEqual (r [safe: 1]?.size (), 3, "The resulting clipped polygon should have 3 vertices.")
        
        if let polygon = r[safe: 1] {
            assertTrue (Geometry2D.isPolygonClockwise (polygon: polygon), "The resulting clipped polygon (hole) should be clockwise.")
        } else {
            fail()
        }
    ...
    public func testExcludePolygons () {
        ...
        assertTrue (r.isEmpty (), "Both polygons are empty. The excluded polygon should also be empty.")
        
        // One polygon is empty
        r = Geometry2D.excludePolygons (polygonA: a, polygonB: b)
        assertEqual (r.size (), 1, "One polygon is non-empty. There should be 1 resulting excluded polygon.")
        assertEqual (r [safe: 0]?.size (), 4, "The resulting excluded polygon should have 4 vertices.")
        assertApproxEqual (r [safe: 0]?[safe: 0], a [0])
        assertApproxEqual (r [safe: 0]?[safe: 1], a [1])
        assertApproxEqual (r [safe: 0]?[safe: 2], a [2])
        assertApproxEqual (r [safe: 0]?[safe: 3], a [3])
        ...
        b.pushBack (value: Vector2 (x: 60, y: 140))
        r = Geometry2D.excludePolygons (polygonA: a, polygonB: b)
        assertEqual (r.size (), 2, "There should be 2 resulting excluded polygons (outline and hole).")
        
        assertEqual (r [safe: 0]?.size (), 4, "The resulting excluded polygon should have 4 vertices.")
        if let polygon = r[safe: 0] {
            assertTrue (!Geometry2D.isPolygonClockwise (polygon: polygon), "The resulting excluded polygon (outline) should be counter-clockwise.")
        } else {
            fail()
        }
        assertApproxEqual (r [safe: 0]?[safe: 0], a [0])
        ...
        assertApproxEqual (r [safe: 0]?[safe: 2], a [2])
        assertApproxEqual (r [safe: 0]?[safe: 3], a [3])
        assertEqual (r [safe: 1]?.size (), 4, "The resulting excluded polygon should have 4 vertices.")
        if let polygon = r[safe: 1] {
            assertTrue (Geometry2D.isPolygonClockwise (polygon: polygon), "The resulting excluded polygon (hole) should be clockwise.")
        } else {
            fail()
        }
    ...
    public func testIntersectPolylineWithPolygon () {
        ...
        assertTrue (r.isEmpty (), "Both line and polygon are empty. The intersection line should also be empty.")
        
        // Line is non-empty and polygon is empty
        r = Geometry2D.intersectPolylineWithPolygon (polyline: l, polygon: PackedVector2Array ())
        assertTrue (r.isEmpty (), "The polygon is empty while the line is non-empty. The intersection line should be empty.")
        
        // Basic intersection with 1 resulting intersection line
        r = Geometry2D.intersectPolylineWithPolygon (polyline: l, polygon: p)
        assertEqual (r.size (), 1, "There should be 1 resulting intersection line.")
        assertEqual (r [safe: 0]?.size (), 2, "The resulting intersection line should have 2 vertices.")
        ...
        r = Geometry2D.intersectPolylineWithPolygon (polyline: l, polygon: p)
        assertEqual (r.size (), 2, "There should be 2 resulting intersection lines.")
        assertEqual (r [safe: 0]?.size (), 2, "The resulting intersection line should have 2 vertices.")
        ...
        assertEqual (r [safe: 1]?.size (), 4, "The resulting intersection line should have 4 vertices.")
    ...
    public func testClipPolylineWithPolygon () {
        ...
        assertTrue (r.isEmpty (), "Both line and polygon are empty. The clipped line should also be empty.")
        
        // Polygon is empty and line is non-empty
        r = Geometry2D.clipPolylineWithPolygon (polyline: l, polygon: PackedVector2Array ())
        assertEqual (r.size (), 1, "There should be 1 resulting clipped line.")
        assertEqual (r [safe: 0]?.size (), 2, "The resulting clipped line should have 2 vertices.")
        ...
        l.pushBack (value: Vector2 (x: 160, y: 320))
        r = Geometry2D.clipPolylineWithPolygon (polyline: l, polygon: p)
        assertEqual (r.size (), 2, "There should be 2 resulting clipped lines.")
        assertEqual (r [safe: 0]?.size (), 3, "The resulting clipped line should have 3 vertices.")
        ...
        assertEqual (r [safe: 1]?.size (), 2, "The resulting clipped line should have 2 vertices.")
    ...
    public func testConvexHull () {
        ...
        assertTrue (r.isEmpty (), "The convex hull should be empty if there are no input points.")
        ...
        assertEqual (r.size (), 1, "Convex hull should contain 1 point.")
        assertApproxEqual (r [safe: 0], b [0])
        
        // All points form the convex hull
        r = Geometry2D.convexHull (points: a)
        assertEqual (r.size (), 8, "Convex hull should contain 8 points.")
        ...
        r = Geometry2D.convexHull (points: a)
        assertEqual (r.size (), 10, "Convex hull should contain 10 points.")
        assertApproxEqual (r [safe: 0], Vector2 (x: -12, y: 4))
