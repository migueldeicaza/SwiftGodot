...
final class EngineVector4Tests {
    ...
    public func testOperators () {
        ...
        XCTAssertEqual ((power1 * 2.0), Vector4 (x: 1.5, y: 3, z: 1.25, w: 0.25), "Vector4 multiplication with powers of two should give exact results.")
        XCTAssertEqual ((int1 * 2.0), Vector4 (x: 8, y: 10, z: 18, w: 4), "Vector4 multiplication with integers should give exact results.")
        
        assertApproxEqual ((decimal1 / 2.0), Vector4 (x: 1.15, y: 2.45, z: 3.9, w: 1.6), "Vector4 division should behave as expected.")
        XCTAssertEqual ((power1 / 2.0), Vector4 (x: 0.375, y: 0.75, z: 0.3125, w: 0.0625), "Vector4 division with powers of two should give exact results.")
        XCTAssertEqual ((int1 / 2.0), Vector4 (x: 2, y: 2.5, z: 4.5, w: 1), "Vector4 division with integers should give exact results.")
    ...
    public func testLinearAlgebraMethods () {
        ...
        XCTAssertEqual ((vectorX * 10.0).dot (with: vectorX * 10.0), 100.0, "Vector4 dot product of same direction vectors should behave as expected.")
