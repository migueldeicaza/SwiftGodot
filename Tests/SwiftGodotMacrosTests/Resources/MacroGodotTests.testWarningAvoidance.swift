    ...
    private static func _initializeClass() {
        ...
        SwiftGodotRuntime._registerPropertyWithGetterSetter(
            ...
            info: SwiftGodotRuntime._propInfo(
                at: \MyClass.data,
                name: SwiftGodotRuntime._convertMemberNameToMatchGodotConvention("data"),
                userHint: nil,
                userHintStr: nil,
                userUsage: nil
            ),
            getterName: StringName("get_" + SwiftGodotRuntime._convertMemberNameToMatchGodotConvention("data")),
            setterName: StringName("set_" + SwiftGodotRuntime._convertMemberNameToMatchGodotConvention("data")),
