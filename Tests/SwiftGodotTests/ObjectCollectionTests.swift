...
final class ObjectCollectionTests: GodotTestCase {
    func testAppendingElementStoresInArray() {
        ...
        XCTAssertEqual(node, Node.fromVariant(variant), "The first element in the \(GArray.self) should hold the appended node")
    ...
    func testInitWithElementsStoresInArray() {
        ...
        XCTAssertEqual(Node.fromVariant(variant), node, "The first element in the \(GArray.self) should be the node passed to init")
    ...
    func testArrayCanBeReassigned() {
        ...
        XCTAssertEqual(Node.fromVariant(variant), otherNode, "The first element in the \(GArray.self) should hold the new node")
