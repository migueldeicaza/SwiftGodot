...
func generateEnums (cdef: JGodotExtensionAPIClass?, values: [JGodotGlobalEnumElement], docClass: DocClass?, prefix: String?) {
    let constantDocs = docClass?.constants?.constant
...
generateEnums(cdef: nil, values: jsonApi.globalEnums, docClass: nil, prefix: "")
